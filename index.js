    ...
    'en': {
        translation: {
            FACTS: [
                ...
                'Six of the 10 youngest English players to make their Champions League debut, have done so whilst playing for Arsenal.',
                'No English side has ever managed to keep a clean sheet on the road against Basel in European competition in all of the 14 such fixtures. Curse!',
                'Yakubu is one of only three teenagers to have scored a hat-trick in the Champions League, alongside Wayne Rooney & Raúl.',
                'No player has been directly involved in more Champions League goals this season than Harry Kane 7',
                'Arsenal have scored 16 headed goals in the Premier League in 2017, three more than any other team.',
                'Kevin De Bruyne has now had a hand in 50 premierleague goals, 16 goals and 34 assists. He has done this in 76 PL apps, which is the quickest by any out-and-out midfielder in the history of the competition',
                ...
                'Since the start of the 2014-15 season, no Premier League side has been given more cards for simulation than Chelsea, a total of 8 times',
                'Zlatan Ibrahimovic is the first player to play for seven different clubs in the Champions League.',
...
const handlers = {
    'LaunchRequest': function () {
        ...
        const speechOutput = "Welcome to football facts!! After hearing the fact, you can say Next, Repeat or Exit " + this.t('GET_FACT_MESSAGE') + randomFact;
        ...
        console.log("THIS.speechoutput = " + speechOutput);
